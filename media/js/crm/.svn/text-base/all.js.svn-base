...
var ChartHelper = function () {
	...
	var visualizeChartColors = ['#00a8a8', '#222', '#777', '#555','#019090','#999','#bbb','#ccc','#eee'];
...
$(function () {			   
	...
	$('.uniformForm').find ("select, input:checkbox, input:radio, input:file").not('.exclude_uniform').uniform();
